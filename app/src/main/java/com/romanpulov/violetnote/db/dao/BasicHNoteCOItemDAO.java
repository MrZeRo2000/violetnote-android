...
public final class BasicHNoteCOItemDAO extends AbstractBasicHEventItemParamDAO<BasicHNoteCOItemA> {
    ...
    public void collapseEvents(long retentionPeriod) {
        ...
        class EventItemTime {
            ...
            EventItemTime(long _id, long event_id, long event_time) {
                this._id = _id;
        ...
        readCursor(new CursorReaderHandler() {
            @Override
            public Cursor createCursor() {
                return mDB.rawQuery(DBRawQueryRepository.H_EVENT_ITEMS_TIME, new String[]{});
            }
